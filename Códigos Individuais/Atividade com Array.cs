    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            //Quest 01            
                int numVez = 1;
                int numIndex = 0;
                Console.Write("Digite o " + numVez + "° número, que eu colocarei no index {" + numIndex + "} ");
                ...
                {
                    Console.WriteLine("O número digitado no index[" + i + "] = " + tester[i]);
                }
            
            //Quest02
                Console.WriteLine("Digite as notas que o aluno tirou, e eu direi a média dele e se ele passou média = 6 .");
                ...
                if (media >= 6)
                {
                    Console.WriteLine("O Aluno passou, pois o mesmo tirou " + media + " na média.");
                }
                else
                {

                    Console.WriteLine("O Aluno não passou, pois o mesmo tirou " + media + " na média.");
                }
            ...
            //Quest03
                ...
                for (int index = 0; index < lista.Length; index++)
                {
                    if (lista[index] == 5)
                    {
                        Console.WriteLine("o Valor 5 está na gaveta " + index);
                    }
                    else
                    {
                        continue;
            ...
            //Quest 06
                ...
                Console.WriteLine("Digite os 3 número que, eu mostrarei eles, e sua localização nos Arrays.");
                ...
                Console.Write("O Terceiro Número é ");
            ...
            //Quest 07
                ...
                Console.WriteLine("Digite dois números que serão usados como referênciais. Sendo ambos positivos e iguais ou menores que 20.\nOBS.: 1° número deve ser menor que o segundo.");
                Console.Write("Primeiro Número Referencial: ");
                int numRef1 = int.Parse(Console.ReadLine());
                Console.Write("Segundo Número Referencial: ");
                ...
                Console.Clear();
                Console.WriteLine("\n{x (pertence) R | a < x < b}");
                Console.WriteLine("Todos os números ímpares existentes entre os números " + numRef1 + " e " + numRef2 + " são: ");
                Thread.Sleep(1500);
